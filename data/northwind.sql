...
The repository also includes the SQL script used to create and load the database:

- `data/northwind.sql` – full SQL dump for restoring the Northwind database in PostgreSQL.